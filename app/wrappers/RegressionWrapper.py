import app.regression.Linear as regr
import app.regression.Rigid as rgd
import app.evaluation.Regression as Eval
import pylab
dataX = [[4,3,3,14,13],
	[4,4,3,13,14],
	[4,3,1,17,12],
...
def testLinear():
	regLin = regr.RegLnr(dataY,dataX,dataYLabels,dataXLabels,False,False)
...
def testRidge():
	regRig = rgd.RegRidge(dataY,dataX,dataYLabels,dataXLabels,True,False)
